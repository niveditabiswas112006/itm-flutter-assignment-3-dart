...
void main() {
  ...
  library.addBook(
    Book(1, 'Clean Code', 'Robert C. Martin', 2008),
  );

  library.addBook(
    Book(2, 'The Pragmatic Programmer', 'Andrew Hunt & David Thomas', 1999),
  );

  library.addBook(
    Book(3, 'Design Patterns', 'Erich Gamma et al.', 1994),
  );

  library.addBook(
    Book(4, 'Refactoring', 'Martin Fowler', 1999),
  );

  library.addBook(
    Book(5, 'Code Complete', 'Steve McConnell', 2004),
  );
